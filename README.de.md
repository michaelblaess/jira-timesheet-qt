...
Auf Cloud genügt der Knopf **Automatisch ermitteln** im Einstellungsdialog (`Strg+,`). Er
...
Die sechs Statusfelder im Einstellungsdialog (`Strg+,`) sind anfangs leer. Deine eigenen
...
woher Token und Feld-ID kommen, steht unter [Voraussetzungen](#voraussetzungen):
